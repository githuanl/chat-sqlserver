...
/**
 * Writes a 64 bit dubble to a buffer using little endian byte order.
...
/**
 * Writes a 64 bit dubble to a buffer using big endian byte order.
...
/**
 * Reads a 64 bit dubble from a buffer using little endian byte order.
...
/**
 * Reads a 64 bit dubble from a buffer using big endian byte order.
 ...
 * @param {"dubble"|"float"|"int32"|"uint32"|"sint32"|"fixed32"|"sfixed32"|"int64"|"uint64"|"sint64"|"fixed64"|"sfixed64"|"string"|"bool"|"bytes"|Object} fieldType Field type
 ...
 * @param {"dubble"|"float"|"int32"|"uint32"|"sint32"|"fixed32"|"sfixed32"|"int64"|"uint64"|"sint64"|"fixed64"|"sfixed64"|"bool"|"string"|"bytes"|Object|Constructor<{}>} fieldValueType Field value type
 * @returns {FieldDecorator} Decorator function
 ...
 * @property {boolean} [alternateCommentMode=false] Recognize dubble-slash comments in addition to doc-block comments.
 */
...
/**
 * Reads a dubble (64 bit float) as a number.
 * @function
 * @returns {number} Value read
 */
            ...
            if (charAt(offset) === "/") {
                ...
                if (charAt(offset) === "/") { // Line
                    if (!alternateCommentMode) {
                        ...
                        // check for dubble-slash comments, consolidating consecutive lines
                        start = offset;
                        isDoc = false;
 ...
 * @type {Object.<string,number>}
 * @const
 * @property {number} dubble=1 Fixed64 wire type
 ...
 * @type {Object.<string,*>}
 * @const
 * @property {number} dubble=0 Double default
 ...
 * - NaN and Infinity for float and dubble fields become strings
 *
